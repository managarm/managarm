...
extern "C" void __ubsan_handle_add_overflow(struct overflow_data *data, uintptr_t, uintptr_t) {
...
extern "C" void __ubsan_handle_sub_overflow(struct overflow_data *data, uintptr_t, uintptr_t) {
...
extern "C" void __ubsan_handle_mul_overflow(struct overflow_data *data, uintptr_t, uintptr_t) {
...
extern "C" void __ubsan_handle_divrem_overflow(struct overflow_data *data, uintptr_t, uintptr_t) {
...
extern "C" void __ubsan_handle_negate_overflow(struct overflow_data *data, uintptr_t) {
...
extern "C" void
__ubsan_handle_shift_out_of_bounds(struct shift_out_of_bounds_data *data, uintptr_t, uintptr_t) {
...
extern "C" void __ubsan_handle_load_invalid_value(struct invalid_value_data *data, uintptr_t) {
...
extern "C" void __ubsan_handle_out_of_bounds(struct out_of_bounds_data *data, uintptr_t) {
...
extern "C" void __ubsan_handle_type_mismatch_v1(struct type_mismatch_data_v1 *data, uintptr_t ptr) {
	if (!ptr) {
...
extern "C" void __ubsan_handle_vla_bound_not_positive(struct vla_bound_data *data, uintptr_t) {
...
extern "C" void
__ubsan_handle_nonnull_return(struct non_null_return_data *, struct source_location *loc) {
