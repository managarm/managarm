...
$c_OBJECTS := device.o drvcore.o epoll.o exec.o fifo.o file.o fs.o inotify.o main.o \
	nl-socket.o process.o pts.o signalfd.o sysfs.o timerfd.o un-socket.o vfs.o
