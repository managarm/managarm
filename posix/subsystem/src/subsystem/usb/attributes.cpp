...
ManufacturerNameAttribute::show(sysfs::Object *object) {
...
async::result<frg::expected<Error, std::string>>
ControllerMaxPowerAttribute::show(sysfs::Object *object) {
...
async::result<frg::expected<Error, std::string>> DescriptorsAttribute::show(sysfs::Object *object) {
	...
	co_return std::string{
	    reinterpret_cast<char *>(device->descriptors.data()), device->descriptors.size()
	};
}
...
async::result<frg::expected<Error, std::string>>
NumConfigurationsAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbDevice *>(object);
...
async::result<frg::expected<Error, std::string>>
InterfaceSubClassAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbInterface *>(object);
	co_return std::format("{:0>2x}\n", device->interfaceSubClass);
}

async::result<frg::expected<Error, std::string>>
InterfaceProtocolAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbInterface *>(object);
	co_return std::format("{:0>2x}\n", device->interfaceProtocol);
}

async::result<frg::expected<Error, std::string>>
AlternateSettingAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbInterface *>(object);
	co_return std::format("{:>2x}\n", device->alternateSetting);
}

async::result<frg::expected<Error, std::string>>
InterfaceNumberAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbInterface *>(object);
...
async::result<frg::expected<Error, std::string>>
EndpointAddressAttribute::show(sysfs::Object *object) {
...
async::result<frg::expected<Error, std::string>>
EpMaxPacketSizeAttribute::show(sysfs::Object *object) {
	auto device = static_cast<UsbEndpoint *>(object);
