...
void KernelFiber::run(
    UniqueKernelStack stack, void (*function)(void *), void *argument, Scheduler *scheduler
) {
...
KernelFiber *thisFiber() { return getCpuData()->activeFiber; }
