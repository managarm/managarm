...
async::result<void>
Cmd::transferToHost2d(uint32_t width, uint32_t height, uint32_t resourceId, GfxDevice *device) {
	...
	co_await virtio_core::scatterGather(
...
async::result<void> Cmd::setScanout(
...
async::result<void>
Cmd::resourceFlush(uint32_t width, uint32_t height, uint32_t resourceId, GfxDevice *device) {
...
async::result<void>
Cmd::create2d(uint32_t width, uint32_t height, uint32_t resourceId, GfxDevice *device) {
...
async::result<void>
Cmd::attachBacking(uint32_t resourceId, void *ptr, size_t size, GfxDevice *device) {
	assert(ptr);
