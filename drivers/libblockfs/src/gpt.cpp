...
BlockDevice *Table::getDevice() { return device; }

size_t Table::numPartitions() { return partitions.size(); }

Partition &Table::getPartition(int index) { return partitions[index]; }
...
Guid Partition::type() { return _type; }
...
async::result<size_t> Partition::getSize() { co_return _numSectors *sectorSize; }
