...
static int libspdm_aead_prealloc(void **context [[maybe_unused]], char const *alg [[maybe_unused]]) {
    return -ENODEV;
}
...
static int libspdm_aead_prealloced(void *context [[maybe_unused]], const uint8_t *key [[maybe_unused]],
        size_t key_size [[maybe_unused]], const uint8_t *iv [[maybe_unused]], size_t iv_size [[maybe_unused]],
        const uint8_t *a_data [[maybe_unused]], size_t a_data_size [[maybe_unused]], const uint8_t *data_in [[maybe_unused]],
        size_t data_in_size [[maybe_unused]], uint8_t *tag [[maybe_unused]], size_t tag_size [[maybe_unused]],
        uint8_t *data_out [[maybe_unused]], size_t *data_out_size [[maybe_unused]], bool enc [[maybe_unused]]) {
    return -ENODEV;
}
...
bool libspdm_aead_aes_gcm_encrypt_prealloc(void *context, const uint8_t *key, size_t key_size,
        const uint8_t *iv, size_t iv_size, const uint8_t *a_data, size_t a_data_size,
        const uint8_t *data_in, size_t data_in_size, uint8_t *tag_out, size_t tag_size,
...
bool libspdm_aead_aes_gcm_decrypt_prealloc(void *context, const uint8_t *key, size_t key_size,
        const uint8_t *iv, size_t iv_size, const uint8_t *a_data, size_t a_data_size,
        const uint8_t *data_in, size_t data_in_size, const uint8_t *tag, size_t tag_size,
        uint8_t *data_out, size_t *data_out_size) {
    int ret;
    if (data_in_size > INT_MAX) {
        return false;
