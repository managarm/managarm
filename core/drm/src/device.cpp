...
const std::vector<drm_core::Crtc *> &drm_core::Device::getCrtcs() { return _crtcs; }

const std::vector<drm_core::Encoder *> &drm_core::Device::getEncoders() { return _encoders; }

const std::vector<drm_core::Connector *> &drm_core::Device::getConnectors() { return _connectors; }
...
void drm_core::Device::registerBufferObject(
    std::shared_ptr<drm_core::BufferObject> obj, std::array<char, 16> creds
) {
...
uint32_t drm_core::Device::getMinWidth() { return _minWidth; }

uint32_t drm_core::Device::getMaxWidth() { return _maxWidth; }

uint32_t drm_core::Device::getMinHeight() { return _minHeight; }

uint32_t drm_core::Device::getMaxHeight() { return _maxHeight; }

drm_core::Property *drm_core::Device::srcWProperty() { return _srcWProperty.get(); }

drm_core::Property *drm_core::Device::srcHProperty() { return _srcHProperty.get(); }

drm_core::Property *drm_core::Device::fbIdProperty() { return _fbIdProperty.get(); }

drm_core::Property *drm_core::Device::modeIdProperty() { return _modeIdProperty.get(); }

drm_core::Property *drm_core::Device::crtcXProperty() { return _crtcXProperty.get(); }

drm_core::Property *drm_core::Device::crtcYProperty() { return _crtcYProperty.get(); }

drm_core::Property *drm_core::Device::planeTypeProperty() { return _planeTypeProperty.get(); }

drm_core::Property *drm_core::Device::dpmsProperty() { return _dpmsProperty.get(); }

drm_core::Property *drm_core::Device::crtcIdProperty() { return _crtcIdProperty.get(); }

drm_core::Property *drm_core::Device::activeProperty() { return _activeProperty.get(); }

drm_core::Property *drm_core::Device::srcXProperty() { return _srcXProperty.get(); }

drm_core::Property *drm_core::Device::srcYProperty() { return _srcYProperty.get(); }

drm_core::Property *drm_core::Device::crtcWProperty() { return _crtcWProperty.get(); }

drm_core::Property *drm_core::Device::crtcHProperty() { return _crtcHProperty.get(); }

drm_core::Property *drm_core::Device::inFormatsProperty() { return _inFormatsProperty.get(); }
