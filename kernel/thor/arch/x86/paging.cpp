...
void KernelPageSpace::mapSingle4k(VirtualAddr pointer, PhysicalAddr physical,
	...
	switch(caching_mode) {
	case CachingMode::writeThrough: new_entry |=  kPagePwt; break;
	case CachingMode::writeCombine:	new_entry |=  kPagePat | kPagePwt; break;
	case CachingMode::uncached: new_entry |=  kPagePwt | kPagePcd | kPagePat; break;
	case CachingMode::null:
	case CachingMode::writeBack: break;
