...
constexpr uint32_t mxcsr_mask = 0b1111110000000;
...
Executor::Executor(UserContext *context, AbiParameters abi) {
	...
	_fxState()->mxcsr |= mxcsr_mask;
	_fxState()->fcw |= fcw_mask;
...
void scrubStackAccessor(Accessor& accessor, const Continuation& cont) {
