...
void setupInputTranslation(Element *element) {
	...
	if (element->usagePage == pages::genericDesktop) {
		...
		if (element->isAbsolute) {
			...
			case 0x30:
				setInput(EV_ABS, ABS_X);
				break;
			case 0x31:
				setInput(EV_ABS, ABS_Y);
				break;
			case 0x38:
				setInput(EV_ABS, ABS_WHEEL);
				break;
			default:
				if (logUnknownCodes)
			...
			switch (element->usageId) {
			case 0x30:
				setInput(EV_REL, REL_X);
				break;
			case 0x31:
				setInput(EV_REL, REL_Y);
				break;
			case 0x38:
				setInput(EV_REL, REL_WHEEL);
				break;
			default:
				if (logUnknownCodes)
					std::cout << "usb-hid: Unknown usage " << element->usageId
		...
		switch (element->usageId) {
		case 0x04:
			setInput(EV_KEY, KEY_A);
			break;
		case 0x05:
			setInput(EV_KEY, KEY_B);
			break;
		case 0x06:
			setInput(EV_KEY, KEY_C);
			break;
		case 0x07:
			setInput(EV_KEY, KEY_D);
			break;
		case 0x08:
			setInput(EV_KEY, KEY_E);
			break;
		case 0x09:
			setInput(EV_KEY, KEY_F);
			break;
		case 0x0A:
			setInput(EV_KEY, KEY_G);
			break;
		case 0x0B:
			setInput(EV_KEY, KEY_H);
			break;
		case 0x0C:
			setInput(EV_KEY, KEY_I);
			break;
		case 0x0D:
			setInput(EV_KEY, KEY_J);
			break;
		case 0x0E:
			setInput(EV_KEY, KEY_K);
			break;
		case 0x0F:
			setInput(EV_KEY, KEY_L);
			break;
		case 0x10:
			setInput(EV_KEY, KEY_M);
			break;
		case 0x11:
			setInput(EV_KEY, KEY_N);
			break;
		case 0x12:
			setInput(EV_KEY, KEY_O);
			break;
		case 0x13:
			setInput(EV_KEY, KEY_P);
			break;
		case 0x14:
			setInput(EV_KEY, KEY_Q);
			break;
		case 0x15:
			setInput(EV_KEY, KEY_R);
			break;
		case 0x16:
			setInput(EV_KEY, KEY_S);
			break;
		case 0x17:
			setInput(EV_KEY, KEY_T);
			break;
		case 0x18:
			setInput(EV_KEY, KEY_U);
			break;
		case 0x19:
			setInput(EV_KEY, KEY_V);
			break;
		case 0x1A:
			setInput(EV_KEY, KEY_W);
			break;
		case 0x1B:
			setInput(EV_KEY, KEY_X);
			break;
		case 0x1C:
			setInput(EV_KEY, KEY_Y);
			break;
		case 0x1D:
			setInput(EV_KEY, KEY_Z);
			break;
		case 0x1E:
			setInput(EV_KEY, KEY_1);
			break;
		case 0x1F:
			setInput(EV_KEY, KEY_2);
			break;
		case 0x20:
			setInput(EV_KEY, KEY_3);
			break;
		case 0x21:
			setInput(EV_KEY, KEY_4);
			break;
		case 0x22:
			setInput(EV_KEY, KEY_5);
			break;
		case 0x23:
			setInput(EV_KEY, KEY_6);
			break;
		case 0x24:
			setInput(EV_KEY, KEY_7);
			break;
		case 0x25:
			setInput(EV_KEY, KEY_8);
			break;
		case 0x26:
			setInput(EV_KEY, KEY_9);
			break;
		case 0x27:
			setInput(EV_KEY, KEY_0);
			break;
		case 0x28:
			setInput(EV_KEY, KEY_ENTER);
			break;
		case 0x29:
			setInput(EV_KEY, KEY_ESC);
			break;
		case 0x2A:
			setInput(EV_KEY, KEY_BACKSPACE);
			break;
		case 0x2B:
			setInput(EV_KEY, KEY_TAB);
			break;
		case 0x2C:
			setInput(EV_KEY, KEY_SPACE);
			break;
		case 0x2D:
			setInput(EV_KEY, KEY_MINUS);
			break;
		case 0x2E:
			setInput(EV_KEY, KEY_EQUAL);
			break;
		case 0x2F:
			setInput(EV_KEY, KEY_LEFTBRACE);
			break;
		case 0x30:
			setInput(EV_KEY, KEY_RIGHTBRACE);
			break;
		case 0x31:
			setInput(EV_KEY, KEY_BACKSLASH);
			break;
		case 0x33:
			setInput(EV_KEY, KEY_SEMICOLON);
			break;
		case 0x34:
			setInput(EV_KEY, KEY_APOSTROPHE);
			break;
		case 0x35:
			setInput(EV_KEY, KEY_GRAVE);
			break;
		case 0x36:
			setInput(EV_KEY, KEY_COMMA);
			break;
		case 0x37:
			setInput(EV_KEY, KEY_DOT);
			break;
		case 0x38:
			setInput(EV_KEY, KEY_SLASH);
			break;
		case 0x3A:
			setInput(EV_KEY, KEY_F1);
			break;
		case 0x3B:
			setInput(EV_KEY, KEY_F2);
			break;
		case 0x3C:
			setInput(EV_KEY, KEY_F3);
			break;
		case 0x3D:
			setInput(EV_KEY, KEY_F4);
			break;
		case 0x3E:
			setInput(EV_KEY, KEY_F5);
			break;
		case 0x3F:
			setInput(EV_KEY, KEY_F6);
			break;
		case 0x40:
			setInput(EV_KEY, KEY_F7);
			break;
		case 0x41:
			setInput(EV_KEY, KEY_F8);
			break;
		case 0x42:
			setInput(EV_KEY, KEY_F9);
			break;
		case 0x43:
			setInput(EV_KEY, KEY_F10);
			break;
		case 0x44:
			setInput(EV_KEY, KEY_F11);
			break;
		case 0x45:
			setInput(EV_KEY, KEY_F12);
			break;
		case 0x46:
			setInput(EV_KEY, KEY_SYSRQ);
			break;
		case 0x47:
			setInput(EV_KEY, KEY_SCROLLLOCK);
			break;
		case 0x48:
			setInput(EV_KEY, KEY_PAUSE);
			break;
		case 0x49:
			setInput(EV_KEY, KEY_INSERT);
			break;
		case 0x4A:
			setInput(EV_KEY, KEY_HOME);
			break;
		case 0x4B:
			setInput(EV_KEY, KEY_PAGEUP);
			break;
		case 0x4C:
			setInput(EV_KEY, KEY_DELETE);
			break;
		case 0x4D:
			setInput(EV_KEY, KEY_END);
			break;
		case 0x4E:
			setInput(EV_KEY, KEY_PAGEDOWN);
			break;
		case 0x4F:
			setInput(EV_KEY, KEY_RIGHT);
			break;
		case 0x50:
			setInput(EV_KEY, KEY_LEFT);
			break;
		case 0x51:
			setInput(EV_KEY, KEY_DOWN);
			break;
		case 0x52:
			setInput(EV_KEY, KEY_UP);
			break;
		case 0x53:
			setInput(EV_KEY, KEY_NUMLOCK);
			break;
		case 0x54:
			setInput(EV_KEY, KEY_KPSLASH);
			break;
		case 0x55:
			setInput(EV_KEY, KEY_KPASTERISK);
			break;
		case 0x56:
			setInput(EV_KEY, KEY_KPMINUS);
			break;
		case 0x57:
			setInput(EV_KEY, KEY_KPPLUS);
			break;
		case 0x58:
			setInput(EV_KEY, KEY_KPENTER);
			break;
		case 0x59:
			setInput(EV_KEY, KEY_KP1);
			break;
		case 0x5A:
			setInput(EV_KEY, KEY_KP2);
			break;
		case 0x5B:
			setInput(EV_KEY, KEY_KP3);
			break;
		case 0x5C:
			setInput(EV_KEY, KEY_KP4);
			break;
		case 0x5D:
			setInput(EV_KEY, KEY_KP5);
			break;
		case 0x5E:
			setInput(EV_KEY, KEY_KP6);
			break;
		case 0x5F:
			setInput(EV_KEY, KEY_KP7);
			break;
		case 0x60:
			setInput(EV_KEY, KEY_KP8);
			break;
		case 0x61:
			setInput(EV_KEY, KEY_KP9);
			break;
		case 0x62:
			setInput(EV_KEY, KEY_KP0);
			break;
		case 0x63:
			setInput(EV_KEY, KEY_KPDOT);
			break;
		case 0x64:
			setInput(EV_KEY, KEY_102ND);
			break;
		case 0xE0:
			setInput(EV_KEY, KEY_LEFTCTRL);
			break;
		case 0xE1:
			setInput(EV_KEY, KEY_LEFTSHIFT);
			break;
		case 0xE2:
			setInput(EV_KEY, KEY_LEFTALT);
			break;
		case 0xE3:
			setInput(EV_KEY, KEY_LEFTMETA);
			break;
		case 0xE4:
			setInput(EV_KEY, KEY_RIGHTCTRL);
			break;
		case 0xE5:
			setInput(EV_KEY, KEY_RIGHTSHIFT);
			break;
		case 0xE6:
			setInput(EV_KEY, KEY_RIGHTALT);
			break;
		case 0xE7:
			setInput(EV_KEY, KEY_RIGHTMETA);
			break;
		default:
			if (logUnknownCodes)
				std::cout << "usb-hid: Unknown usage " << element->usageId << " in Keyboard Page"
				          << std::endl;
		}
		...
		switch (element->usageId) {
		case 0x01:
			setInput(EV_KEY, BTN_LEFT);
			break;
		case 0x02:
			setInput(EV_KEY, BTN_RIGHT);
			break;
		case 0x03:
			setInput(EV_KEY, BTN_MIDDLE);
			break;
		default:
			if (logUnknownCodes)
				std::cout << "usb-hid: Unknown usage " << element->usageId << " in Button Page"
				          << std::endl;
		}
	} else {
		if (logUnknownCodes)
...
HidDevice::HidDevice() { _eventDev = std::make_shared<libevbackend::EventDevice>(); }
...
async::detached HidDevice::run(proto::Device device, int config_num, int intf_num) {
	...
	proto::walkConfiguration(descriptor, [&](int type, size_t, void *p, const auto &info) {
		...
		if (type == proto::descriptor_type::hid) {
			...
			assert(
			    desc->length ==
			    sizeof(HidDescriptor) + (desc->numDescriptors * sizeof(HidDescriptor::Entry))
			);
	...
	for (size_t i = 0; i < report_descs.size(); i++) {
		...
		(co_await device.transfer(proto::ControlTransfer{proto::kXferToHost, get_descriptor, buffer}
		 ))
		    .unwrap();
	...
	for (size_t i = 0; i < elements.size(); i++) {
		...
		if (element->inputType == EV_ABS)
			_eventDev->setAbsoluteDetails(
			    element->inputCode, element->logicalMin, element->logicalMax
			);
	...
	if (logFields)
		for (size_t i = 0; i < fields.size(); i++) {
			std::cout << "Field " << i << ": [" << fields[i].arraySize
			          << "]. Bit size: " << fields[i].bitSize << ", signed: " << fields[i].isSigned
			          << std::endl;
		}

	// Create an mbus object for the device.
	mbus_ng::Properties mbusDescriptor{{"unix.subsystem", mbus_ng::StringItem{"input"}}};

	auto entity =
	    (co_await mbus_ng::Instance::global().createEntity("input-usb-hid", mbusDescriptor))
	        .unwrap();
	...
	while (true) {
		...
		interpret(fields, reinterpret_cast<uint8_t *>(report.data()), length, values);

		if (logFieldValues) {
			for (size_t i = 0; i < values.size(); i++)
				if (values[i].first)
					std::cout << "usagePage: " << elements[i].usagePage << ", usageId: 0x"
					          << std::hex << elements[i].usageId << std::dec
...
async::detached bindDevice(mbus_ng::Entity entity) {
		    ...
		    if (type == proto::descriptor_type::configuration) {
			    ...
			    if (intf_number) {
				    std::cout << "usb-hid: Ignoring secondary HID interface: "
				              ...
				              << ", alternative: " << info.interfaceAlternative.value()
				              << std::endl;
				    return;
			    }
	...
	std::cout << "usb-hid: Detected HID device. "
	             "Interface: "
	          << intf_number.value() << ", alternative: " << intf_alternative.value() << std::endl;
...
async::detached observeDevices() {
	auto filter = mbus_ng::Conjunction{
	    {mbus_ng::EqualsFilter{"usb.type", "device"}, mbus_ng::EqualsFilter{"usb.class", "00"}}
	};
