...
enum BaudRate { low9600 = 0x0C, high9600 = 0 };

enum class DataBits { charLen5 = 0, charLen6 = 1, charLen7 = 2, charLen8 = 3 };

enum class StopBits { one = 0, two = 1 };

enum class Parity { none = 0, odd = 1, even = 3, mark = 5, space = 7 };
...
enum class IrqCtrl { disable = 0, enable = 1 };

enum class IrqIds { lineStatus = 3, dataAvailable = 2, charTimeout = 6, txEmpty = 1, modem = 0 };
