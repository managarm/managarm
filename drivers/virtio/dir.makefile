...
$c_OBJECTS := main.o block.o virtio.o hw.pb.o
...
all-$c: $($c_BINDIR)/virtio

clean-$c:
	rm -f $($d_BINDIR)/virtio $($d_OBJECT_PATHS) $($d_OBJECT_PATHS:%.o=%.d)

install-$c: $($c_BINDIR)/virtio
	install $($d_BINDIR)/virtio $(SYSROOT_PATH)/usr/bin
...
$($c_BINDIR)/virtio: $($c_OBJECT_PATHS) | $($c_BINDIR)
