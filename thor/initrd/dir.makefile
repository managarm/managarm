...
all-$c: $($c_BINDIR)/initrd

clean-$c:
	rm -f $($d_BINDIR)/initrd $($d_OBJECT_PATHS) $($d_OBJECT_PATHS:%.o=%.d)
...
$($c_BINDIR)/initrd: $($c_OBJECT_PATHS) | $($c_BINDIR)
...
gen-$c: $($c_GENDIR)/fs.frigg_pb.hpp $($c_GENDIR)/mbus.frigg_pb.hpp
