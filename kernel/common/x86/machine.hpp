...
enum {
	...
	kMsrPkgCstConfigControl = 0x000000E2,
	kMsrIa32PowerCtl = 0x000001FC,
	kMsrPAT = 0x00000277,
	kMsrIa32PmEnable = 0x00000770,
	kMsrIa32HwpCapabilities = 0x00000771,
	kMsrIa32HwpRequest = 0x00000774,
