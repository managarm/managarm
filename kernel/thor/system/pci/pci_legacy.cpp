...
uint8_t LegacyPciConfigIo::readConfigByte(
...
uint16_t LegacyPciConfigIo::readConfigHalf(
    uint32_t seg, uint32_t bus, uint32_t slot, uint32_t function, uint16_t offset
) {
	assert(!seg);
...
uint32_t LegacyPciConfigIo::readConfigWord(
    uint32_t seg, uint32_t bus, uint32_t slot, uint32_t function, uint16_t offset
) {
	assert(!seg);
...
void LegacyPciConfigIo::writeConfigByte(
...
void LegacyPciConfigIo::writeConfigHalf(
...
void LegacyPciConfigIo::writeConfigWord(
