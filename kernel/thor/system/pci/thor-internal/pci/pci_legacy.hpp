...
[[gnu::weak]] uint32_t
readLegacyPciConfigWord(uint32_t bus, uint32_t slot, uint32_t function, uint32_t offset);
[[gnu::weak]] uint16_t
readLegacyPciConfigHalf(uint32_t bus, uint32_t slot, uint32_t function, uint32_t offset);
[[gnu::weak]] uint8_t
readLegacyPciConfigByte(uint32_t bus, uint32_t slot, uint32_t function, uint32_t offset);

[[gnu::weak]] void writeLegacyPciConfigWord(
    uint32_t bus, uint32_t slot, uint32_t function, uint32_t offset, uint32_t value
);
[[gnu::weak]] void writeLegacyPciConfigHalf(
    uint32_t bus, uint32_t slot, uint32_t function, uint32_t offset, uint16_t value
);
[[gnu::weak]] void writeLegacyPciConfigByte(
