...
int nvlink_strcmp(const char *a, const char *b) {
    return strcmp(a, b);
}
...
NvlStatus nvlink_acquire_fabric_mgmt_cap(void *osPrivate [[maybe_unused]], NvU64 capDescriptor [[maybe_unused]]) STUBBED;
