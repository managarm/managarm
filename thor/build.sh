...
ld -nostdlib -z max-page-size=0x1000 -T src/link.ld -o bin/kernel.elf obj/frigg-gdt.o obj/frigg-idt.o obj/runtime0.o obj/runtime1.o obj/main.o obj/debug.o obj/memory-physical-alloc.o obj/memory-paging.o obj/memory-kernel-alloc.o
